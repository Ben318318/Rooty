...
import { getSession, submitAttempt, SessionRoot } from '../lib/api';
...
export default function Session() {
    ...
    const themeId = searchParams.get('theme') ? Number(searchParams.get('theme')) : null;
    ...
    if (error) {
        return (
            <div className="container" style={{ marginTop: '2rem', textAlign: 'center' }}>
                ...
                <Button onClick={() => navigate('/learn')} style={{ marginTop: '1rem' }}>
                    Back to Learn
                </Button>
            </div>
        );
