        ...
        <div className={styles.quizCard}>
            ...
            {feedback && (
                <div className={`${styles.feedback} ${styles[feedback]}`}>
                    {feedback === 'correct' ? (
                        <>
                            ✓ Correct! The root <strong>{root.root_text}</strong> means "{root.meaning}".
                        </>
                    ) : (
                        <>
                            ✗ Not quite. The root <strong>{root.root_text}</strong> means "{root.meaning}".
                        </>
                    )}
                </div>
            )}
